...
public class MessagePortInputFormatSingle : MessagePortDynamicsRelated {
    public readonly Byte mode;
    public readonly UInt32 deltaInterval;
    public readonly bool notificationEnabled;

    public MessagePortInputFormatSingle(UInt32 hubID, UInt32 portID, UInt32 mode, UInt32 deltaInterval, bool notificationEnabled)
        : base(hubID, LegoMessageType.PORT_INPUT_FORMAT_SINGLE, portID)
    {
        this.mode = (Byte)mode;
    ...
    internal static new MessagePortInputFormatSingle parse(BinaryReader __buffer, Byte hubID, Byte portID) {
        // Extract fields:
        ...
        return new MessagePortInputFormatSingle(hubID, portID, mode, deltaInterval, notificationEnabled);
    }

    override
    public void visitWith<T>(MessagePortDynamicsRelated_Visitor<T> visitor, T arg) {
        visitor.handle_MessagePortInputFormatSingle(this, arg);
    }
