...
public class MessageHubAttachedIODetached : MessageHubAttachedIO {
    public MessageHubAttachedIODetached(UInt32 hubID, UInt32 portID)
        : base(hubID, portID, 0x0)
    {
    }
    ...
    internal static new MessageHubAttachedIODetached parse(BinaryReader __buffer, Byte hubID, Byte portID) {
        // Extract fields:
        #pragma warning disable 0219 // Ignore unused variables
        #pragma warning restore 0219

        return new MessageHubAttachedIODetached(hubID, portID);
    }

    override
    public void visitWith<T>(MessagePortConnectivityRelated_Visitor<T> visitor, T arg) {
        visitor.handle_MessageHubAttachedIODetached(this, arg);
    }
