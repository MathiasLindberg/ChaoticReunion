...
public class EraseFlashResp : UpstreamMessage {
    public readonly Byte errorCode;

    public EraseFlashResp(UInt32 errorCode)
        : base(BootloaderMessageType.ERASE_FLASH)
    {
