...
public class EraseFlashReq : DownstreamMessage {
    public EraseFlashReq()
    ...
    internal static new EraseFlashReq parse(BinaryReader __buffer) {
        // Extract fields:
        #pragma warning disable 0219 // Ignore unused variables
        #pragma warning restore 0219

        return new EraseFlashReq();
    }

    override
    public void visitWith<T>(DownstreamMessage_Visitor<T> visitor, T arg) {
        visitor.handle_EraseFlashReq(this, arg);
    }
