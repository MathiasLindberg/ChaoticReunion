...
public class Disconnect : DownstreamMessage {
    public Disconnect()
        : base(BootloaderMessageType.DISCONNECT)
    {
    }
    ...
    internal static new Disconnect parse(BinaryReader __buffer) {
        // Extract fields:
    ...
    public void visitWith<T>(DownstreamMessage_Visitor<T> visitor, T arg) {
        visitor.handle_Disconnect(this, arg);
    }
