...
public class StartAppReq : DownstreamMessage {
    public StartAppReq()
        : base(BootloaderMessageType.START_APP)
    {
    }
    ...
    internal static new StartAppReq parse(BinaryReader __buffer) {
        // Extract fields:
    ...
    public void visitWith<T>(DownstreamMessage_Visitor<T> visitor, T arg) {
        visitor.handle_StartAppReq(this, arg);
    }
